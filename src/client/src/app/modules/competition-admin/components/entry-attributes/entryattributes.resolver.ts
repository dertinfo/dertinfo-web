...
@Injectable()
export class EntryAttributesResolver implements Resolve<Observable<any>> {
    constructor(
    ...
    resolve(activatedRoute: ActivatedRouteSnapshot) {
        ...
        if (this._tracker.hasLoadedEntryAttributes() && this._tracker.competitionId === id) {

            return of(this._tracker.entryAttributes);

        } else {

            const entryAttributes$ = this._competitionRepo.entryAttributes(id);
