...
import { ActivityMemberAttendanceDto, MemberAttendanceDto } from '../../../../models/dto';
...
export class GroupRegistrationMembersComponent implements OnInit, OnDestroy {
  ...
  public attendingMembers$: Observable<MemberAttendanceDto[]>;
  ...
  ngOnInit() {
    ...
    this.attendingMembers$ = this._tracker.memberAttendances$.pipe(
      map(attendingMembers => attendingMembers
        .filter(attendingMember => attendingMember.groupMemberType === MemberType.active)));
