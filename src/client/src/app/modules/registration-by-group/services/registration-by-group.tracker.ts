...
@Injectable()
export class RegistrationByGroupTracker {
    ...
    public get overview(): GroupRegistrationOverview {
    ...
    public set overview(overview: GroupRegistrationOverview) {
    ...
    public set allMembers(allMembers: GroupMemberDto[]) {
        this._memoryStore.allGroupMembers = allMembers;
        this._allGroupMembers.next(this._memoryStore.allGroupMembers);
    }

    public set allTeams(allTeams: GroupTeamDto[]) {
        this._memoryStore.allGroupTeams = allTeams;
        this._allGroupTeams.next(this._memoryStore.allGroupTeams);
    }
    ...
    private _capabilitiesLocked = false;

    // #region Observables and Subjects

    private _registrationOverview = new BehaviorSubject<GroupRegistrationOverview>(null);
    ...
    private _memoryStore: {
        registrationOverview: GroupRegistrationOverview,
        memberAttendances: MemberAttendanceDto[],
        teamAttendances: TeamAttendanceDto[],
        allGroupMembers: GroupMemberDto[],
        allGroupTeams: GroupTeamDto[],
    ...
    public hasLoadedAllMembers(): boolean {
        return this._memoryStore.allGroupMembers !== null;
    }

    public hasLoadedAllTeams(): boolean {
        return this._memoryStore.allGroupTeams !== null;
    }
    ...
    public focusMemberAttendance(memberAttendanceId: number) {
        ...
        console.log('GroupRegistrationTracker - focusMemberAttendance - memberAttendanceId', memberAttendanceId);
    ...
    public reset(): void {
        ...
        this._activitiesForIndividuals.next([]);
